...
<head>
    ...
    <title>@yield('title') | Hph Store</title>
            ...
            <div class="inner-header">
                <div class="row">
                    <div class="col-lg-2 col-md-2">
                        <div class="logo">
                            <a href="/">
                                <img src="front/img/Kawaii.png" alt="">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-7 col-md-7" style="margin-top: 20px">
                        <form action="shop">
                            <div class="advanced-search">
                                <button type="button" class="category-btn">Danh mục SP</button>
                    ...
                    <div class="col-lg-3 col-md-3 text-right" style="margin-top: 20px">
                        <ul class="nav-right">
                            <li class="heart-icon">
                                <a href="#">
                            ...
                            <li class="cart-icon">
                                ...
                                <div class="cart-hover">
                                    ...
                                    <div class="select-button">
                                        ...
                                        <a href="./checkout" class="primary-btn view-card">Thanh toán</a>
                                    </div>
                                </div>
                            </li>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="footer-left">
                        ...
                        <ul>
                            <li>Nguyen Cu Trinh, Quan 1, Tp.HCM</li>
                            <li>Phone: +84 36 228 2969</li>
                            <li>Email: quochung0304@gmail.com</li>
                        </ul>
