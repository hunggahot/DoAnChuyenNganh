                        ...
                        <ul class="vertical-nav-menu">
                            ...
                            <li class="mm-active">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="eProject_Sem2_Template_Admin/order.html">
                                            <i class="metismenu-icon"></i>Order
                                        </a>
                                    </li>
                                    <li>
                                        <a href="eProject_Sem2_Template_Admin/product.html">
                                            <i class="metismenu-icon"></i>Product
                                        </a>
                                    </li>
                                    <li>
                                        <a href="eProject_Sem2_Template_Admin/category.html">
                                            <i class="metismenu-icon"></i>Category
                                        </a>
                                    </li>
                                    <li>
                                        <a href="eProject_Sem2_Template_Admin/brand.html">
                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            ...
                            <div class="page-title-actions">
                                <a href="eProject_Sem2_Template_Admin/user-create.html" class="btn-shadow btn-hover-shine mr-3 btn btn-primary">
                                    ...
                                    <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="eProject_Sem2_Template_Admin/user-show.html"
                                                        class="btn btn-hover-shine btn-outline-primary border-0 btn-sm">
                                                        Details
                                                    </a>
                                                    <a href="eProject_Sem2_Template_Admin/user-edit.html" data-toggle="tooltip" title="Edit"
