                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        ...
                        @csrf
                            ...
                            <div class="position-relative row form-group">
                                <label for="funds"
                                       class="col-md-3 text-md-right col-form-label">Giá vốn</label>
                                <div class="col-md-9 col-xl-8">
                                    <input required name="funds" id="funds"
                                           placeholder="Giá vốn" type="text" class="form-control" value="">
                                </div>
                            </div>
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="price" id="price"
                                        placeholder="Giá bán" type="text" class="form-control" value="">
                                </div>
                            </div>
...
{{--                            </div>--}}
                            ...
                            <div class="position-relative row form-group">
                                <label for="description"
                                    class="col-md-3 text-md-right col-form-label">Chi tiết mô tả</label>
                                <div class="col-md-9 col-xl-8">
                                    <textarea class="form-control" name="description" id="description" placeholder="Chi tiết mô tả"></textarea>
                                </div>
                            </div>
