...
<div class="app-container app-theme-white body-tabs-shadow fixed-header fixed-sidebar">
    <div class="app-header header-shadow">
        <div class="app-header__logo">
            <img src="dashboard/assets/images/Kawaii1.png" style="width: 50%; margin-left: 40px" alt="">
...
<script type="text/javascript" src="./dashboard/assets/scripts/main1.js"></script>
